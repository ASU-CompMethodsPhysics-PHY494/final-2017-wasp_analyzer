...
blotch = np.ones_like(star, dtype=np.bool)
blotchr = 8
...
#plotarray(star,('Limb Darkening Simulation of WASP55: Star Radius of %s' % a))
...
for x in range(2*center):
    planet_positions.append(shift_planet(star.shape, rp, x, y = center))
...
plt.title("Sight of WASP55B over WASP55")
plt.show()
...
plt.title("Light Curve of WASP55 of radius %s and y at %s" % (a, "center") )
plt.show()
'''
